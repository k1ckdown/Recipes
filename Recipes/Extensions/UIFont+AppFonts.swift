...
extension UIFont {
    ...
    static let measureTitle = UIFont.systemFont(ofSize: 15)
    static let detailTitle = UIFont.systemFont(ofSize: 20, weight: .medium)
    ...
    static let ingredientDetailName = UIFont.systemFont(ofSize: 17, weight: .bold)
}
